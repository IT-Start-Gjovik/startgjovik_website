        ...
        <main className='bg-gray-900 min-h-screen'>
            ...
            <div className='bg-white'>
                <div className='container flex flex-wrap mx-auto max-w-7xl sm:px-6 lg:px-8 justify-around text-center'>
                    ...
                    {/*Bildet vises ikke*/}
                    {/* <div className='flex flex-col md:flex-row w-full p-5 sm:px-6'>
                        <div className='flex justify-center md:w-1/2 lg:w-1/2 xl:w-1/3'>
                            <Image src='/images/ntnugjøvik.jpg' alt='ntnu' width={750} height={100} />
                        </div>
                        <div className='md:w-1/2 lg:w-1/2 xl:w-2/3'>
                            <h1 className='text-slate-900 font-medium text-xl'>What is Lorem Ipsum?</h1>
            ...
            <section className='bg-gray-900'>
                <div className='container mx-auto max-w-7xl p-6 lg:p-8'>
                    <h1 className='text-7xl font-extrabold'>
                        Styre <span className='bg-gradient-to-r from-blue-400 to-white text-transparent bg-clip-text'>Medlemmer</span>
                    </h1>

                    <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-40 mt-12'>
                        {styre.map((styre) => (
            ...
            <section>{/*Bilde/logo av sponser*/}</section>
