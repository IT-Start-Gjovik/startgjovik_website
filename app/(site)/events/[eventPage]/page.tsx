  ...
  return (
    <main className="min-h-screen bg-gradient-to-tl from-gradient-end via-gradient-mid to-gradient-start flex justify-center">
      <div className="bg-slate-100 w-3/4 h-fit p-20">
        ...
        <Link href={!isOver ? event.url : "#"} className={`inline-flex items-center px-3 py-2 mt-10 text-sm font-medium text-center rounded-lg  focus:ring-4 focus:outline-none ${isOver ? "cursor-not-allowed bg-gray-500" : "bg-blue-600 hover:bg-blue-700 focus:ring-blue-800 "
          } `}>
          Påmelding
