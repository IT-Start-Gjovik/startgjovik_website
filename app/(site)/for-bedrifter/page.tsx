    ...
    return (
        <div className='bg-gray-900 min-w-screen-lg mx-auto'>
            <main className='bg-gray-900 h-full'>
                <Header />
                <h1 className=' mb-7 text-5xl md:text-7xl text-center font-bold'>
                    For bedrifter
                </h1>
                ...
                <div className='flex justify-center h-fit mb-3'>
                    <div className='grid w-4/5 sm:grid-cols-1 xl:grid-cols-2 h-auto p-7 shadow-slate-700 bg-slate-900 rounded-xl shadow-2xl xl:justify-self-start'>
                        ...
                        <article className='xl:p-4 rounded-lg w-full sm:justify-self-center xl:justify-self-end xl:col-span-1 xl:h-auto'>
                            <h2 className='text-2xl xl:ml-10 font-extrabold mb-2'>
                                Hva får du ut av et samarbeid?
                            </h2>
                            <p className='xl:p-4 xl:text-xl leading-snug overflow-auto text-pretty'>
                                Start Gjøvik tilbyr bedrifter og organisasjoner
                                muligheten til å samarbeide med engasjerte studenter
                                fra NTNU Gjøvik. Dette gir dere muligheten til å
                                utvikle nye fremtidige medarbeidere og
                                samarbeidspartnere til deres bedrift eller
                                organisasjon.
                            </p>
                        </article>
                    </div>
                    ...
                    <div className='grid w-4/5 gap-3 sm:grid-cols-1 md:grid-cols-3 h-auto'>
                        <article className='flex flex-col items-center justify-center shadow-slate-700 bg-slate-900 rounded-xl p-4'>
                            ...
                            <p className='xl:p-2 xl:text-xl leading-snug overflow-auto text-pretty'>
                                Vi tilbyr et miljø for å skape innovative ideer
                                gjennom våre workshops, foredrag og andre
                                arrangementer. Her kan dere spille en aktiv rolle i å
                                forme morgendagens innovatører, samtidig som det gir
                                en gyllen anledning for å profilere deres bedrift
                                eller organisasjon, og demonstrere deres engasjement
                                og ekspertise.
                            </p>
                        </article>
                        <article className='flex flex-col items-center justify-center shadow-slate-700 bg-slate-900 rounded-xl p-4'>
                            ...
                            <p className='xl:p-2 xl:text-xl leading-snug overflow-auto text-pretty'>
                                Vi gir dere muligheten til å utvikle deres bedrift
                                eller organisasjon gjennom aktiv kompetanseutveksling
                                med studenter. Dette åpner for en verdifull innsikt
                                fra den neste generasjonen av entreprenører, og gir
                                dere muligheten til å forstå og integrere nye, friske
                                perspektiver i deres virksomhet.
                            </p>
                        </article>
                        <article className='flex flex-col items-center justify-center shadow-slate-700 bg-slate-900 rounded-xl p-4'>
                            <h2 className='text-2xl mb-2 font-extrabold'>
                            ...
                            <p className='xl:p-2 xl:text-xl leading-snug overflow-auto text-pretty'>
                                Ved å bli en del av vårt nettverk, åpner dere dørene
                                til en verden av muligheter, der dere kan knytte
                                kontakter med studenter, akademiske institusjoner,
                                samt en rekke bedrifter og organisasjoner. Denne
                                forbindelsen gir en unik mulighet for vekst og
                                utvikling, idet den sammenfører ulike perspektiver og
                                ekspertise.
                            </p>
                        </article>
                    </div>
                    ...
                    <div className='grid h-auto sm:grid-cols-1 md:grid-cols-2 w-4/5 shadow-slate-700 bg-slate-900 rounded-xl shadow-2xl'>
                        <div className=' rounded-lg w-[90%] justify-self-center  '>
                            <article className='shadow-slate-700 bg-slate-900 rounded-xl p-2'>
                                <h2 className='text-2xl mb-4 font-extrabold text-center'>
                                    Kontakt oss
                                </h2>
