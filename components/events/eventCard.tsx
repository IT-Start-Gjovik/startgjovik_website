    ...
    return (
        <div className="flex flex-col items-center border rounded-lg shadow md:flex-row md:max-w-xl max-w-md border-gray-700 bg-gray-800 hover:bg-gray-700">
            ...
            <div className="flex flex-col justify-between p-4 leading-normal"> 
                ...
                <h4> 📅 {date}</h4>
                <h4>🕕 {time}</h4>
                <Link href={`/events/${slug}`} className="inline-flex items-center px-3 py-2 mt-2 text-sm font-medium text-center text-white  rounded-lg focus:ring-4 focus:outline-none  bg-blue-600 hover:bg-blue-700 focus:ring-blue-800">
                    Les meir
