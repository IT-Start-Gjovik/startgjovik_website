...
export default function SustainabilityGoal({ title, description, imageSrc, linkUrl }: SustainabilityImageProps) {
    return (
        <div className='w-fit m-auto flex flex-col items-center justify-center hover:scale-105 duration-500 border-b border-l border-r border-solid rounded-2xl py-1'>
            ...
            <p className='flex-1 max-w-[280px] text-center mx-1 overflow-x-clip text-lg'>{description}</p>
        </div>
    );
}
